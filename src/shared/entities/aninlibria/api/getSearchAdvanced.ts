...
export const getSearchAdvanced = ({axiosConfig, params}: {axiosConfig?: AxiosRequestConfig, params?: TSearchAdvanced}) => {
    return callApi<TSearchAdvanced, TitlesPagination>({ api: $anilibria_api, method: 'GET', endpoint: '/title/search/advanced', axiosConfig, params });
}